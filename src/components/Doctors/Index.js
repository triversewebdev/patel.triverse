...
const Index = () => {
  ...
  return (
    <Container _parentClass='doctors p-100 gray_Background'>
            <Title firstHeading={'Our Expert'} secondHeading={'MEET OUR DOCTORS'} _class={'mt-0'}/>
            <div className='col-lg-11 m-auto position-relative slider mt-5'>
            <SlickSlider slides={Data} slidesToShow={4} slidesToScroll={1} sliderClass={'doctorslide'} slide__content={'doctorsinfo col-12 float-start bg-white border p-4'} sliderImageClass={'doctorsprofile'} sliderImageWidth={'314'} sliderImageHeight={'259'} showButton={true}/>
            </div>
    </Container>
  )
}
