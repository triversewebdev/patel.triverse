...
const menuData = [
  { name: "Home", link: "/" },
  {
    ...
    submenus: [
      {
        icon: <Heart themeColor="primary-color" />,
        text: "Patel Heart Advanced Cardiac Centre",
        link: "/centres-of-excellence/patel-heart",
      },
      {
        icon: <Nephrology themeColor="primary-color" />,
        text: "Patel Advanced Nephro-Urology",
      },
      {
        icon: <Breathing themeColor="primary-color" />,
        text: "The Head & Neck Centre of Excellence Patel Hospital",
      },
      {
        icon: <Liver themeColor="primary-color" />,
        text: "Patel Center of Excellence Liver & Digestive Care",
      },
      {
        icon: <Robotic themeColor="primary-color" />,
        text: "Patel Robotic Surgery Centre",
      },
      {
        icon: <Radiology themeColor="primary-color" />,
        text: "Patel Advanced Cancer Institute",
      },
      {
        icon: <Pulmonology themeColor="primary-color" />,
        text: "Department of Pulmonology",
      },
      {
        icon: <Radiology themeColor="primary-color" />,
        text: "Patel Advanced Laparoscopy Center",
      },
